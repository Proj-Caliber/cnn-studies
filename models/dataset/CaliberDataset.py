...
from ..PTV import transforms as T

if (__name__ == '__main__') or (__name__ == 'models.dataset.CaliberDataset'):
    ...
    class CustomDataset(Dataset):
        # root 라고 적힌 부분 데이터 경로에 맞게 수정하기!
        # transforms도 unet을 계획하고 작성한 부분이라...다시 수정하기!
        def __init__(self, root, mode=mode, transforms = None):
            self.root = root
